  ...
  return (
    <section className="flex items-center container mx-auto py-16 w-11/12">
      <section className="w-6/12 pr-8">
        ...
        <h2 data-aos="fade-up" data-aos-delay="1200" className="text-5xl font-bold my-3">Join us, we’ve made<br/><span data-aos="fade-up" data-aos-delay="1800">a lot look elegant</span></h2>
