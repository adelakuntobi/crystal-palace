...
const Login = () => {
  return (
    <section className="flex items-center justify-center">
      ...
      <div className="mx-auto w-6/12 lg:w-4/12 container">
        <p className="absolute top-0 right-0 mt-8 mr-8 font-bold">Not a member? <Link to="/signup" className="text-blue-700">Sign up now</Link></p>
